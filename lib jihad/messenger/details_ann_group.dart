...
class DetailsAnnonceGroup extends StatefulWidget {
  DetailsAnnonceGroup(
      this.ads, this.user, this.listp, this.auth, this.analytics, this.chng);
...
class _ShopCardState extends State<DetailsAnnonceGroup> {
              ...
              child: new Row(
                ...
                children: <Widget>[
                  ...
                  new Column(
                    ...
                    children: <Widget>[
                      new Text(
                          widget.ads.author1.fullname.toString() +
                              " " +
                              widget.ads.author1.firstname.toString(),
                          style: new TextStyle(
                              color: Fonts.col_app,
                              fontWeight: FontWeight.bold,
                              fontSize: 13.0)),
                      new Text(
                        widget.ads.createdAt == null
                            ? ""
                            : new DateFormat('yyyy-MM-dd')
                                .format(DateTime.parse(widget.ads.createdAt)),
                        style: new TextStyle(
