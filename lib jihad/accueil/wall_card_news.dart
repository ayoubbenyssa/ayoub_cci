...
import 'package:mycgem/widgets/custom_widgets/im_widget_2.dart';
    ...
    if (widget.offers.type == "Mission" ||
      ...
      Navigator.push(context,
        ...
        return new DetailsAnnonce(
            widget.offers, widget.user, widget.list, null, widget.analytics,null);
      }));
      ...
      Navigator.push(context,
        ...
        return new DetailsParc(widget.offers, widget.user, widget.offers.type,
            widget.list, null, widget.analytics, widget.lat, widget.lng, null);
      }));
    }
