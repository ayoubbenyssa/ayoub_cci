...
import 'package:mycgem/services/buy_services.dart';
import 'package:mycgem/services/favorite_service.dart';
import 'package:flutter/services.dart';

class BuyButton extends StatefulWidget {
  BuyButton(this.offer, this.user, this.show, {this.verify});
...
class _FavoriteButtonState extends State<BuyButton>
   ...
   */
    if (val)
      ...
      showInSnackBar("Vous avez bénéficier de cette convention");
  }
            ...
            child: new Container(
                ...
                child: new Container(
                    ...
                    child: new Column(
                      ...
                      Center(
                          child: Text("Bénéficiez d'une convention:",
                              style: TextStyle(
        ...
        builder: (BuildContext context) => new AlertDialog(
            ...
            content: Container(
                ...
                child: Column(children: <Widget>[
                  Text(LinkomTexts.of(context)
                      .option() /*"Cette option est réservée aux membres vérifiés ! Contactez votre administrateur pour validez votre compte et profitez des tarifs préférentiels."*/),
                ]))));
  }
