...
class ChatScreen extends StatefulWidget {
  ChatScreen(this.myid, this.idOther, this.list_partners, this.goto, this.auth,
      this.analytics, this.onLocaleChange,
    ...
    database.GetUserInfo(widget.idOther).then((User us) {
      try {
        ...
        setState(() {
          ...
          msgidOther.name =
              AppServices.capitalizeFirstofEach(us.firstname?.toLowerCase()) +
                  " " +
                  us.fullname.toUpperCase();
    ...
    database.GetUserInfo(widget.myid).then((val) {
      try {
        setState(() {
          ...
          msgMyId.name =
              AppServices.capitalizeFirstofEach(val.firstname?.toLowerCase()) +
                  " " +
