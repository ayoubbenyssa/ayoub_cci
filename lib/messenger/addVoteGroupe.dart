...
class AddVoteGroup extends StatefulWidget {
  AddVoteGroup(this.user, this.list,this.nom_groupe,{this.type});
...
class _AddVoteState extends State<AddVoteGroup> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      var aa = await parse_s.postparse('Group', js);
                ...
                var js = {
                  "id_send": widget.user.id,
                  "title": widget.nom_groupe,
                  "post_title1": _descctrl.text,
                  "type": "sondage",
                  "active": 1,
                  "author": {
                    "__type": "Pointer",
               ...
               var a =  await parse_s.postparse('Group', js);

               String id = a["objectId"];
               //
