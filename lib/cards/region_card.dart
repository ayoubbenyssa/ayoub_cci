...
class Region_card extends StatefulWidget {
  Region_card(this.region,this.funcall,this.searchText,this.func);
...
class _Entreprise_cardState extends State<Region_card> {
  List<String> st = [];
