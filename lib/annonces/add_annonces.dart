...
class _AddAnnonceState extends State<AddAnnonce> {
  List<String> _list = ["Général", "Annonces", "Sondage"];
...
//      platformVersion = 'Failed to get platform version.';
  ...
  confirm() async {
    ...
    /* } else if (im == "") {
      ...
      setState(() {
        error = "Choisir le type d'annonce";
      });
    } else {
      onLoading(context);

      if (widget.selectedValue == "Offre d'emploi") {
        widget.selectedValue = "Mission";
      }
      ...
      var js = {
        ...
        "image": im,
        "pictures": images,
        "type": widget.selectedValue + "_raja",
