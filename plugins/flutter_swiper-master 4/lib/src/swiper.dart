...
const int kDefaultAutoplayDelayMs = 1000;

///  Default auto play transition duration (in millisecond)
const int kDefaultAutoplayTransactionDuration = 250;
...
class _TinderState extends _CustomLayoutStateBase<_TinderSwiper> {
  ...
  void didChangeDependencies() {
    ...
    _startIndex = -3;
    _animationCount = 5;
    opacity = [0.0, 0.9, 0.9, 1.0, 0.4, 0.1];
    scales = [0.80, 0.80, 0.85, 0.90, 0.5, 0.5, 0.5];
