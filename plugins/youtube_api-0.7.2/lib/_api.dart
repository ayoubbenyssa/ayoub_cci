class API {
  ...
  Uri channelUri(String channelId, String order,page) {
    this.order = order ?? 'date';
    var options = getChannelOption(channelId, this.order,page);
    Uri url = new Uri.https(baseURL, "youtube/v3/search", options);
...
//  For Getting Getting Next Page
  ...
  Object getChannelOption(String channelId, String order,page) {
    print(page);
