...
//  For Searching on YouTube
  ...
  Future<List> channel(String channelId,key, {String order}) async {
    print("<333");
    Uri url = api.channelUri(channelId, order, nextPageToken);
    String ur = "";
    ...
    if (nextPageToken == "") {
      ...
      var res = await http.get(
          "https://www.googleapis.com/youtube/v3/search?channelId=$channelId&part=snippet&order=date&maxResults=20&key=" + key+
              ur, headers: {"Accept": "application/json"});
      var jsonData = json.decode(res.body);
      List<YT_API> result = _getResultFromJson(jsonData);
      return result;
    }
