                  ...
                  // padding: const EdgeInsets.only(left: 8.0,right: 8.0),
                    child: widget.user.verify.toString() != "1"
                      ...
                      child: Container(
                          ...
                          child: Text(
                            "Vous devez être membre de la CGEM pour poster une opportunité d'affaires",
                      ...
                      child: Container(
                        ...
                        children: <Widget>[
                          ...
                          widget.user.entreprise.objectId ==
                              "v9bGl0EENk"
                              ? row("Actualité", "images/news.png",
                              tap, 30.0, 30.0, "Actualité")
                              : Container(),
                          Container(
                            height: 16,
                          ),
                          widget.user.entreprise.objectId ==
                              "v9bGl0EENk"
                              ? row("Événement", "images/cale.png",
                              tap, 35.0, 35.0, "Événement")
                              : Container(),
                          widget.user.entreprise.objectId ==
                              "v9bGl0EENk"
                              ? Container(
    ...
    return new AppBar(
        ...
        title: GestureDetector(
            ...
            child: Padding(
                ...
                child: Image.asset(
                    _page == 1 ? "images/netw.png" : "images/c.png",
                    width: ScreenUtil().setWidth(_page == 3 ? 34 : 34)))),
          ...
          Padding(
              ...
              child: IconButton(
                ...
                icon: new Stack(children: <Widget>[
                  new Image.asset("images/bell.png",
                      color: Fonts.col_ap_fonn,
