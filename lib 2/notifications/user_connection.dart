...
class _UserConnState extends State<UserConn> {
  ...
  getUserInfo() async {
    ...
    var response = await parse_s.getparse('users?where={"id1":"$id"}&include=commissions&include=membre_user.federation&include=membre_user.region&include=fonction');
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
        appBar: new AppBar(title: new Text(LinkomTexts.of(context).dem())),
        body: loading
            ...
            : new Container(
                ...
                child: new ListTile(
                  ...
                  title: new Text(user.firstname.toString() +
                      " " +
                      user.fullname.toString()),
                  subtitle: new Text(user.fonction.name.toString().toUpperCase()),
                  trailing: new RaisedButton(
                    ...
                    child: new Text(LinkomTexts.of(context).confirm()),
                  ),
                ),
              ));
  }
