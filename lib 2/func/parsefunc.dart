...
//http://217.182.139.190:1351
  final JsonDecoder _decoder = new JsonDecoder();
  String urlclasse = "http://217.182.139.190:1383/parse/classes/";
  ...
  Future<List<String>> fileUpload(
    ...
    final url = 'http://217.182.139.190:1383/parse/files/aa.'+ext;
    ...
    request.headers.add("X-Parse-Application-Id", "C9EcHeKgPkRnUrWtYw3y5A8DaFcJfMhQmSp");
    request.headers
        .add('X-Parse-Master-Key', 'nTrWtYw3y5A8DaFcJfMhPmSpUsXuZw4z6B8');
