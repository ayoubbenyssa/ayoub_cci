...
class SSRegion_card extends StatefulWidget {
  SSRegion_card(this.region,this.funcall,this.searchText,this.func);
...
class _Entreprise_cardState extends State<SSRegion_card> {
  List<String> st = [];
  ...
  Widget build(BuildContext context) {
    return (!widget.region.name.toString().toLowerCase().contains(widget.searchText.toString().toLowerCase()) &&
