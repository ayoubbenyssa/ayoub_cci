...
class CreateNewEntrepriseForm extends StatefulWidget {
  CreateNewEntrepriseForm(this.email, this.id, this.chng);
...
class _EntrepriseFormState extends State<CreateNewEntrepriseForm>
  ...
  /**
       entreprise, association partenaires
   */
...
*/
  create_entreprise(name, contact, entreprise) async {
    ...
    User ctc = new User(
        ...
        fonction: Fonction(name: _titrecontroller.text, id: id_fonction),
...
// Start validating on every change.
      ...
      setState(() {
        _authHint = "Veuillez choisir la civilité !";
      });
    } else if (document == "" && type_e != "partenaire") {
      setState(() {
        _authHint = type_e == "entreprise"
            ? "Entrez le modèle J !"
            : "Entrez les statuts ! ";
      });
    } else if (ville_id == "") {
      setState(() {
        _authHint = "Veuillez choisir la ville !";
      });
    } else if (_pacontroller.text == "") {
      setState(() {
        _authHint = "Veuillez choisir le pays !";
      });
    } else {
      print("jihad");
      setState(() {
...
*/
    ...
    Widget titre = GestureDetector(
        onTap: () async {
          setState(() {
            _authHint = "";
          });

          Fonction vi = await Navigator.push(context,
              new MaterialPageRoute(builder: (BuildContext context) {
          ...
          new Row(
            children: <Widget>[
              ...
              new Text(
                type_e == "partenaire"
                    ? "Ajouter le logo :"
                    : "Ajouter le logo de votre $type_e :",
    ...
    Widget doc = new InkWell(
      child: new Column(
        children: <Widget>[
          type_e == "entreprise" || type_e == "association"
              ? new Row(
                  children: <Widget>[
                    new Container(
                      width: 12.0,
                    ...
                    new Text(
                      type_e == "entreprise"
                          ? "Ajouter le modèle J/7 de votre entreprise :"
                          : "Ajouter les statuts de votre association :",
                      style: new TextStyle(
                          color: Colors.grey[600], fontSize: 15.6),
                    ),
                    new Container(
                      width: 12.0,
                    ),
