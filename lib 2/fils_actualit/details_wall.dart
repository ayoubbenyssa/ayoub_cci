...
class Wall_card_details extends StatefulWidget {
  Wall_card_details(this.offers, this.user, this.list, this.analytics, this.lat,
      this.lng, this.chng);
...
class _Wall_carState extends State<Wall_card_details> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text(""),
          backgroundColor: Fonts.col_app_fonn,
        ),
                        ...
                        child: new Row(
                          ...
                          children: <Widget>[
                            ...
                            new Column(
                              ...
                              children: <Widget>[
                                new Text(
                                  AppServices.capitalizeFirstofEach(widget.offers
                                        .author1.firstname?.toString().toLowerCase()) +
                                        " " +
