...
class AnnonceCard extends StatefulWidget {
  AnnonceCard(this.offer, this.user, this.auth, this.sign, this.analytics,
      this.observer, this.list_partner, this.chng);
    ...
    Navigator.push(context, new MaterialPageRoute(
        builder: (BuildContext context) {
          return new ChatScreen(
              my_id, his_id, widget.list_partner, false, widget.auth,widget.analytics,widget.chng,
              user: user_me);
        }));
  }
            ...
            new GestureDetector(
                ...
                child: new Container(
                    ...
                    child: widget.offer.image == "" ? new FadingImage.asset(
                      ...
                      height: height * 0.26,
                      fit: BoxFit.contain,
                    ) : widget.offer.image==null?Container():new FadingImage.network(
                      widget.offer.image,
                      width: width * 0.29,
                      height: height * 0.24,
                      fit: BoxFit.cover,
                    ...
                    child: new Row(
                      ...
                      children: <Widget>[
                        ...
                        new Column(
                          ...
                          children: <Widget>[
                            new Text(
                              AppServices.capitalizeFirstofEach(widget.offer.author.firstname?.toLowerCase()) +
                                    " " +
                                    AppServices.capitalizeFirstofEach(widget.offer.author.fullname.toString().toUpperCase()),
                                style: new TextStyle(
                                    color: Fonts.col_app,
                                    fontWeight: FontWeight.w500,
                                    fontSize: 11.5)),
                            new Text(
                              new DateFormat('dd-MM-yyyy').format(DateTime.parse(widget.offer.createdAt)),
                              style: new TextStyle(
                                  color: Colors.grey[600],
                                  //  fontWeight: FontWeight.bold,
                                  fontSize: 11.0),
