...
class EntreproseList extends StatefulWidget {
  EntreproseList(this.lat, this.lng, this.id);
...
class _EntreproseListState extends State<EntreproseList> {
  ...
  getList() async {
    var a = await PartnersList.get_list_entreprise1(0);
    ...
    return Scaffold(
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                        ...
                        hintText: '   Rechercher un organsime',
      ...
      body: ListView(
        ...
        children: load?[Center(child: Widgets.load())]:ent
            .map((val) => new Entreprise_card(val, func, _searchText, sete))
            .toList(),
      ) /*StreamParcPub(
