...
class _InfoUser1State extends State<OrganismeTitle> {
  ...
  void initState() {
    ...
    _titrectrl.text = widget.user.fonction.name;
  ...
  Widget build(BuildContext context) {
    ...
    Widget titre = Widgets.textfield_dec("Titre de votre profil", _titrefocus,
        widget.user.fonction.name, _titrectrl, TextInputType.text, val.valprofile);
            ...
            new IconButton(
                ...
                onPressed: () async {
                  ...
                  if (!form.validate()) {
                    ...
                    widget.user.fonction.name = _titrectrl.text;
