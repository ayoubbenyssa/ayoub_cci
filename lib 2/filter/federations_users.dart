...
class FilterByFederationUsers extends StatefulWidget {
  FilterByFederationUsers(this.commission, this.user, this.lat, this.lng,
...
class _UsersStreamState extends State<FilterByFederationUsers> {
  int count1 = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: MyCgemBarApp(
          widget.commission.sectorName.toString(),
