...
class FilterByNew extends StatefulWidget {
  FilterByNew(this.user, this.lat, this.lng, this.list_partner, this.analytics,
      this.chng);
...
class _UsersStreamState extends State<FilterByNew> {
  int count1 = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 1,
          title: Text(
            "Trier par nouveaux utilisateurs",
